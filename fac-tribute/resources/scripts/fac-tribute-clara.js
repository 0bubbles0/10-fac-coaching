...
const quizThanks = () => {
  quizSection.style.backgroundColor = "#e0d2b3";
...
oldImg.addEventListener("click", newImg)
inputField.addEventListener("change", quizThanks)
pMore.addEventListener("click", readOn)